/*
JOINS -->
INNER JOIN: commn data | row that satisfies the condition
...
*/
use scott;
select d.loc, d.dname,e.ename from emp e right outer join dept d
...
#SELF JOIN:
select c1.city,c1.name from sales c1 inner join sales c2 
